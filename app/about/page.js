        ...
        <div>
          ...
          <div className="values-grid">
            {[
              ...
              ["Perspicacious", "We cultivate sharp, penetrating insight into businesses and markets. Surface-level analysis is never sufficient; we seek to understand what others overlook and act where the crowd cannot."],
            ].map(([title, desc]) => (
              <div key={title} className="hover-card" style={{ padding: 24, background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 4, display: "flex", flexDirection: "column" }}>
